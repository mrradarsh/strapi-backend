...
`,gr=y(I)`
  flex: 1;
  min-width: 0;
`,pr=({folder:e})=>{const{formatMessage:n}=$(),{navigateToFolder:s}=Ze(),{isMovePending:o}=ne()??{isMovePending:!1},{draggable:{attributes:r,listeners:a,setNodeRef:i,isDragging:l},droppable:{setNodeRef:g},showValidDropHighlight:f,showInvalidDropCursor:c}=en(e),p=m=>{i(m),g(m)},v=m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),s(e))};return t.jsxs(cr,{ref:p,...r,...a,$isDragging:l,$isMovePending:o,$isValidDropTarget:f,$isInvalidDropTarget:c,onClick:()=>s(e),onKeyDown:v,role:"listitem",tabIndex:0,children:[t.jsx(ur,{children:t.jsx(ue,{width:20,height:20})}),t.jsx(gr,{textColor:"neutral800",ellipsis:!0,children:e.name}),t.jsx(Q,{label:n({id:u("control-card.more-actions"),defaultMessage:"More actions"}),variant:"ghost",onClick:m=>m.stopPropagation(),children:t.jsx(Re,{})})]})},dt=y(A)`
  position: relative;
  width: 100%;
  padding-bottom: 62.5%;
  height: 0;
...
`,Ir=y(Ct)`
  ...
  border-bottom: 1px solid ${({theme:e})=>e.colors.neutral150};
`,Sr=({asset:e})=>{const{ext:n,mime:s}=e,o=xe(s,n);return t.jsx(w,{justifyContent:"center",alignItems:"center",borderRadius:"4px",color:"neutral500",width:"3.2rem",height:"3.2rem",shrink:0,children:t.jsx(o,{width:20,height:20})})},Rr=({asset:e,onAssetItemClick:n})=>{const s=We(),{formatDate:o,formatMessage:r}=$(),{isMovePending:a}=ne()??{isMovePending:!1},{attributes:i,listeners:l,setNodeRef:g,isDragging:f}=Jt(e),c=p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),n(e.id))};return t.jsxs(tn,{ref:g,...i,...l,$isDragging:f,$isMovePending:a,tabIndex:0,role:"row",onDragStart:p=>p.preventDefault(),onClick:()=>n(e.id),onKeyDown:c,children:[t.jsx(K,{children:t.jsxs(w,{gap:3,alignItems:"center",children:[t.jsx(Sr,{asset:e}),t.jsxs(w,{direction:"column",alignItems:"flex-start",children:[t.jsx(I,{textColor:"neutral800",fontWeight:"semiBold",ellipsis:!0,children:e.name}),s&&t.jsx(I,{textColor:"neutral600",variant:"pi",children:e.size?Oe(e.size,1):"-"})]})]})}),!s&&t.jsxs(t.Fragment,{children:[t.jsx(K,{children:t.jsx(I,{textColor:"neutral600",children:e.createdAt?o(new Date(e.createdAt),{dateStyle:"long"}):"-"})}),t.jsx(K,{children:t.jsx(I,{textColor:"neutral600",children:e.updatedAt?o(new Date(e.updatedAt),{dateStyle:"long"}):"-"})}),t.jsx(K,{children:t.jsx(I,{textColor:"neutral600",children:e.size?Oe(e.size,1):"-"})})]}),t.jsx(K,{children:t.jsx(w,{justifyContent:"flex-end",children:t.jsx(Q,{label:r({id:u("control-card.more-actions"),defaultMessage:"More actions"}),variant:"ghost",onClick:p=>p.stopPropagation(),children:t.jsx(Re,{})})})})]})},$r=y(tn)`
  &:hover {
    background: ${({theme:e})=>e.colors.primary100};
  }
...
`,ln=({node:e,level:n,currentFolderId:s,isExpanded:o,onToggle:r,onSelect:a})=>{const{formatMessage:i}=$();if(e.id==null)return null;const l=e.id,g=e.name??"",f=(e.children?.length??0)>0,c=o(l),p=s===l;return t.jsxs("li",{children:[t.jsxs(w,{alignItems:"center",paddingLeft:`${n*zr}rem`,gap:1,children:[t.jsx(Q,{label:i({id:u(c?"sidebar.tree.collapse":"sidebar.tree.expand"),defaultMessage:c?"Collapse {name}":"Expand {name}"},{name:g}),onClick:v=>{v.stopPropagation(),r(l)},variant:"ghost",withTooltip:!1,"aria-expanded":c,children:t.jsx(Vr,{$expanded:c,fill:"neutral500"})}),t.jsx(A,{flex:"1",minWidth:0,children:t.jsx(on,{type:"button",$isActive:p,"aria-current":p?"page":void 0,onClick:()=>a(l),"data-testid":`folder-tree-node-${l}`,"data-folder-id":l,children:t.jsx(Ur,{name:g,isActive:p})})})]}),f&&c&&t.jsx(an,{children:e.children.map(v=>t.jsx(ln,{node:v,level:n+1,currentFolderId:s,isExpanded:o,onToggle:r,onSelect:a},v.id??v.name))})]})},Hr=y(w)`
